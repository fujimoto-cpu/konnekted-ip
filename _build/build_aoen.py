...
SOURCES = [
 ...
 ("Wikipedia / Aoen","https://en.wikipedia.org/wiki/Aoen"),("Oricon デビュー7名確定","https://www.oricon.co.jp/news/2381064/full/"),
 ("Oricon HAKU→HIKARU改名","https://www.oricon.co.jp/news/2390102/full/"),("kprofiles aoen","https://kprofiles.com/aoen-members-profile/"),
 ("UtaTen aoen","https://utaten.com/specialArticle/index/9586"),("kpoptune aoen","https://kpoptune.jp/artist/1837"),
]
...
# 文献
H.append('<section><div class="sh"><span class="no">📚</span><h2>文献・出典</h2></div><div class="card"><div class="srcgrid">')
for n,u in SOURCES: H.append('<a href="'+u+'" target="_blank">'+esc(n)+'</a>')
H.append('</div><p class="note" style="margin-top:10px">画像は公式サイト profile ページ及び公式 Weverse Shop から取得（2026-06-16時点）。情報は上記各ソースを二重照合。</p></div></section>')
